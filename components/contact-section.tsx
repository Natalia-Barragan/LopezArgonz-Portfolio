...
import { Mail, Linkedin, MapPin, AlertCircle } from "lucide-react"
import { BackToTop } from "@/components/back-to-top"

export function ContactSection() {
  return (
    <section id="contacto" className="py-20 md:py-32 px-4 bg-muted/30 relative">
      <BackToTop />
      <div className="container mx-auto max-w-4xl">
        ...
        <footer className="text-center text-sm text-muted-foreground pt-8 border-t border-border">
          <p>© {new Date().getFullYear()} Gastón López Argonz. Hecho por <a href="https://nbdigital.lat/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">NBDigital</a></p>
